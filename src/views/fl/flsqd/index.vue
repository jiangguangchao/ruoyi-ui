  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="患者姓名" prop="hzXm">
        <el-input v-model="queryParams.hzXm" placeholder="请输入患者姓名" clearable size="small"
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      ...
      <el-form-item label="放疗单状态" prop="fldzt">
        <el-select v-model="queryParams.fldzt" placeholder="请选择放疗单状态" clearable size="small">
          <el-option v-for="dict in dict.type.fl_fldzt" :key="dict.value" :label="dict.label" :value="dict.value" />
        </el-select>
      </el-form-item>
      <el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
          v-hasPermi="['fl:flsqd:export']">导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="flsqdList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button v-show="scope.row.fldzt == 'wks'" size="mini" type="text" icon="el-icon-edit"
            @click="handleStart(scope.row)" v-hasPermi="['fl:flsqd:edit']">开启</el-button>
    ...
    <el-dialog :visible.sync="allocateDigOpen" title="选择操作人员" width="500px">
      <el-select v-model="selectedWorker" placeholder="请选择操作人员">
        <el-option v-for="item in postUserList" :key="item.userId" :label="item.userName"
